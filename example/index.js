...
var view = yo`
  <div>
    <main id="minimap-content" style="position:absolute;top:0;left:0;width:calc(100% - ${width}px);height:100%;overflow:auto">
    ...
    <aside style="position:absolute;top:0;left:calc(100% - ${width}px);right:0;height:100%">
      ${map}
    </aside>
  </div>
`
